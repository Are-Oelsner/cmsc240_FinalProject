...
int main() {
	...
	Section::Section section = new Section();
	...
	Section::Section uNeighbor = new Section();
	Section::Section rNeighbor = new Section();
	Section::Section dNeighbor = new Section();
	Section::Section lNeighbor = new Section();
